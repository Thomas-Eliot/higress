...
// DeepCopyInto supports using ResourceTemplateSchemaEntry within kubernetes types, where deepcopy-gen is used.
func (in *ResourceTemplateSchemaEntry) DeepCopyInto(out *ResourceTemplateSchemaEntry) {
	p := proto.Clone(in).(*ResourceTemplateSchemaEntry)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceTemplateSchemaEntry. Required by controller-gen.
func (in *ResourceTemplateSchemaEntry) DeepCopy() *ResourceTemplateSchemaEntry {
	if in == nil {
		return nil
	}
	out := new(ResourceTemplateSchemaEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new ResourceTemplateSchemaEntry. Required by controller-gen.
func (in *ResourceTemplateSchemaEntry) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
